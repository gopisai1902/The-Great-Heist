...
const TokenCollection = (params) => {
    ...
    const [transaction, setTransaction] = useState(story.transactions[params.idx])
            ...
            >
                ...
                <Modal.Footer>
                    ...
                    }
                    {
                        idx + 1 === displayClose
                            ?
                            <Button variant="success" onClick={params.handleNextQues}>
                                Close
                            </Button>
                            :
